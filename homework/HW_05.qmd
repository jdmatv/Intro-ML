...
svi_covid[predictors] = scaler.fit_transform(svi_covid[predictors])
...
print(f"Mean Squared Error of the test set predictions: {round(np.mean((y_test - y_test_pred)**2),4)}")
```
